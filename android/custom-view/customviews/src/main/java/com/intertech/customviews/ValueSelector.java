...
public class ValueSelector extends RelativeLayout {
    ...
    private OnValueSelectListener valueSelectListener;
    ...
    private void incrementValue() {
        ...
        if(currentVal < maxValue) {
            ...
            valueSelectListener.selectedValue(i);
        }
    }
    ...
    public void setOnValueSelectListener(OnValueSelectListener obj){
        valueSelectListener = obj;
    }
    public interface OnValueSelectListener{
        void selectedValue(int i);
    }
}
